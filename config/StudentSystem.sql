...
DROP PROCEDURE IF EXISTS ArchiveExamProc;
DELIMITER //
CREATE PROCEDURE ArchiveExamProc(IN theDATE DATE)
BEGIN
INSERT INTO ARCHIVERESULT (SELECT * FROM EXAMRESULT WHERE UpdateAt <= theDATE);
END; //
DELIMITER ;